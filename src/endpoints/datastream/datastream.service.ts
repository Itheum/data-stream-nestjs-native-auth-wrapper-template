...
export class DatastreamService {
  ...
  placeholderFunction() {
    ...
    */
    ...
    const callerAddress = "address"; // @TODO: how can I get this from the native auth token?
    const marshalInjectedChainID = "req.headers?.['itm-marshal-fwd-chainid']"; // @TODO: how can I get this from req.headers
    const marshalInjectedTokenID = "req.headers?.['itm-marshal-fwd-tokenid']"; // @TODO: how can I get this from req.headers
